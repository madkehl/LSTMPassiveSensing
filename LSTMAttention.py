...
def create_attentionLSTM(winsorized, random, n_steps, learn, rdo, do, activ_h, KI_h, loss_fctn, size_dense, size_lstm, epochs, batch):
    ...
    lstm_layer1 = tf.keras.layers.LSTM(size_lstm, recurrent_dropout =rdo, dropout = do, return_sequences = True)
    query_seq_encoding1 = lstm_layer1(query_seq_encoding)
    value_seq_encoding1 = lstm_layer1(value_seq_encoding)
    lstm_layer2 = tf.keras.layers.LSTM(size_lstm, return_sequences = True)
    query_seq_encoding2 = lstm_layer2(query_seq_encoding1)
    value_seq_encoding2 = lstm_layer2(value_seq_encoding1)
